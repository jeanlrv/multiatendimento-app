...
DO $$ BEGIN
    IF NOT EXISTS (
        ...
        WHERE constraint_name = 'users_roleId_fkey' AND table_name = 'users'
    ) THEN
        ALTER TABLE "users"
...
DO $$ BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.table_constraints
        WHERE constraint_name = 'roles_companyId_fkey' AND table_name = 'roles'
    ) THEN
        ALTER TABLE "roles"
...
DO $$ BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.columns
        WHERE table_name = 'companies' AND column_name = 'logoUrl'
    ) THEN
...
DO $$ BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.columns
        WHERE table_name = 'companies' AND column_name = 'primaryColor'
    ) THEN
        ALTER TABLE "companies" ADD COLUMN "primaryColor" TEXT NOT NULL DEFAULT '#3B82F6';
    END IF;
END $$;
...
DO $$ BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.columns
        WHERE table_name = 'companies' AND column_name = 'secondaryColor'
    ) THEN
        ALTER TABLE "companies" ADD COLUMN "secondaryColor" TEXT NOT NULL DEFAULT '#1E293B';
    END IF;
END $$;
...
DO $$ BEGIN
    ALTER TABLE "ai_agents" ALTER COLUMN "companyId" DROP DEFAULT;
EXCEPTION WHEN others THEN NULL;
END $$;

DO $$ BEGIN
    ALTER TABLE "evaluations" ALTER COLUMN "companyId" DROP DEFAULT;
EXCEPTION WHEN others THEN NULL;
END $$;
...
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'InternalChatType') THEN
...
DO $$ BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.table_constraints
        WHERE constraint_name = 'internal_chats_companyId_fkey' AND table_name = 'internal_chats'
    ) THEN
        ALTER TABLE "internal_chats"
            ADD CONSTRAINT "internal_chats_companyId_fkey"
            FOREIGN KEY ("companyId") REFERENCES "companies"("id")
            ON DELETE RESTRICT ON UPDATE CASCADE;
    END IF;
END $$;
...
CREATE UNIQUE INDEX IF NOT EXISTS "internal_chat_members_chatId_userId_key"
    ON "internal_chat_members"("chatId", "userId");
...
DO $$ BEGIN
    IF NOT EXISTS (
        ...
        ALTER TABLE "internal_chat_members"
            ADD CONSTRAINT "internal_chat_members_chatId_fkey"
            FOREIGN KEY ("chatId") REFERENCES "internal_chats"("id")
...
DO $$ BEGIN
    IF NOT EXISTS (
        ...
        ALTER TABLE "internal_chat_members"
            ADD CONSTRAINT "internal_chat_members_userId_fkey"
...
DO $$ BEGIN
    IF NOT EXISTS (
        ...
        ALTER TABLE "internal_chat_messages"
            ADD CONSTRAINT "internal_chat_messages_chatId_fkey"
            FOREIGN KEY ("chatId") REFERENCES "internal_chats"("id")
            ON DELETE CASCADE ON UPDATE CASCADE;
    END IF;
END $$;
...
DO $$ BEGIN
    IF NOT EXISTS (
        ...
        ALTER TABLE "internal_chat_messages"
            ADD CONSTRAINT "internal_chat_messages_senderId_fkey"
...
DO $$ BEGIN
    IF NOT EXISTS (
        ...
        ALTER TABLE "saved_filters"
            ADD CONSTRAINT "saved_filters_companyId_fkey"
            FOREIGN KEY ("companyId") REFERENCES "companies"("id")
            ON DELETE RESTRICT ON UPDATE CASCADE;
    END IF;
END $$;
...
DO $$ BEGIN
    IF NOT EXISTS (
        ...
        WHERE tablename = 'tags' AND indexname = 'tags_companyId_name_key'
    ) THEN
...
DO $$ BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.columns
        WHERE table_name = 'workflow_rules' AND column_name = 'config'
    ) THEN
        ALTER TABLE "workflow_rules" ADD COLUMN "config" JSONB;
    END IF;
END $$;
...
DO $$ BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.columns
        WHERE table_name = 'workflow_rules' AND column_name = 'runCount'
    ) THEN
        ALTER TABLE "workflow_rules" ADD COLUMN "runCount" INTEGER NOT NULL DEFAULT 0;
    END IF;
END $$;
...
DO $$ BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.columns
        WHERE table_name = 'workflow_rules' AND column_name = 'environment'
    ) THEN
        ALTER TABLE "workflow_rules" ADD COLUMN "environment" TEXT NOT NULL DEFAULT 'PRODUCTION';
    END IF;
END $$;
...
DO $$ BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.columns
        WHERE table_name = 'workflow_rules' AND column_name = 'isTemplate'
    ) THEN
        ALTER TABLE "workflow_rules" ADD COLUMN "isTemplate" BOOLEAN NOT NULL DEFAULT false;
    END IF;
END $$;
...
DO $$ BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.columns
        WHERE table_name = 'workflow_rules' AND column_name = 'version'
    ) THEN
        ALTER TABLE "workflow_rules" ADD COLUMN "version" INTEGER NOT NULL DEFAULT 1;
    END IF;
END $$;
...
DO $$ BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.columns
        WHERE table_name = 'integrations' AND column_name = 'zapiClientToken'
    ) THEN
        ALTER TABLE "integrations" ADD COLUMN "zapiClientToken" TEXT;
    END IF;
END $$;
...
DO $$ BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.columns
        WHERE table_name = 'integrations' AND column_name = 'webhookUrl'
    ) THEN
        ALTER TABLE "integrations" ADD COLUMN "webhookUrl" TEXT;
    END IF;
END $$;
...
DO $$ BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.columns
        WHERE table_name = 'departments' AND column_name = 'emoji'
    ) THEN
        ALTER TABLE "departments" ADD COLUMN "emoji" TEXT DEFAULT '💬';
    END IF;
END $$;
...
DO $$ BEGIN
    IF NOT EXISTS (
        ...
        ALTER TABLE "departments" ADD COLUMN "color" TEXT NOT NULL DEFAULT '#2563eb';
    END IF;
END $$;
...
DO $$ BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.columns
        WHERE table_name = 'departments' AND column_name = 'displayOrder'
    ) THEN
...
DO $$ BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.columns
        WHERE table_name = 'departments' AND column_name = 'workflowId'
    ) THEN
...
DO $$ BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.columns
        WHERE table_name = 'departments' AND column_name = 'slaResolutionMin'
    ) THEN
        ALTER TABLE "departments" ADD COLUMN "slaResolutionMin" INTEGER;
    END IF;
END $$;
...
DO $$ BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.columns
        WHERE table_name = 'departments' AND column_name = 'greetingMessage'
    ) THEN
        ALTER TABLE "departments" ADD COLUMN "greetingMessage" TEXT;
    END IF;
END $$;
