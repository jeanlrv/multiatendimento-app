...
import { Database, Plus, Trash2, FileText, Globe, FileUp, Loader2, CheckCircle, Activity, ChevronRight, ChevronLeft, Save, Zap, FileCode, UploadCloud, RefreshCw, Music, Youtube, Github, FileSpreadsheet, Presentation, BookOpen, Braces, AlignLeft, X, Download, CheckSquare, Square, Wifi, WifiOff, Copy, RotateCcw, MonitorSmartphone, Clock, AlertCircle, ChevronDown } from 'lucide-react';
                                ...
                                <div className={`rounded-2xl border overflow-hidden transition-colors ${webhookEnabled ? 'border-primary/40 bg-primary/5 dark:bg-primary/10' : 'border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-white/5'}`}>
                                    ...
                                    {webhookEnabled && (
                                        <div className="border-t border-slate-200 dark:border-white/10">
                                            <button
                                                onClick={showSyncLogs ? () => setShowSyncLogs(false) : handleLoadSyncLogs}
                                                    ...
                                                    {loadingSyncLogs ? (
                                                        ...
                                                        <div className="space-y-1">
                                                            <div className="flex items-center justify-end mb-2">
                                                                <button onClick={handleLoadSyncLogs} className="text-[9px] font-black uppercase tracking-widest text-primary flex items-center gap-1 hover:opacity-70 transition-opacity">
